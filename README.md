...
```shell
opctl pkg install github.com/opspec-pkgs/nintex.workflowcloud.instance.create#1.1.0
```
...
```yaml
op:
  pkg: { ref: github.com/opspec-pkgs/nintex.workflowcloud.instance.create#1.1.0 }
  inputs:
    url:
  outputs:
    instanceToken:
